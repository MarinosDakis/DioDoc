...
export default function ChangePassword({ currentId, setCurrentId }) {
    ...
    const handleShowPassword3 = () => setShowPassword3((prevShowPassword3) => !prevShowPassword3);
    ...
    return (
        <Paper className={classes.paper}>
          <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={isValid() === true ? handleSubmit : null}>
            ...
            <Input name="currentPassword" label="Current Password" value={resetPasswordData.currentPassword} type={showPassword1 ? "text" : "password"} handleChange={handleChange} handleShowPassword={handleShowPassword1} autoFocus/>
            <Input name="newPassword" label="New Password" value={resetPasswordData.newPassword} type={showPassword2 ? "text" : "password"} handleChange={handleChange} handleShowPassword={handleShowPassword2} />
            <Input name="confirmNewPassword" label="Confirm New Password" value={resetPasswordData.confirmNewPassword} type={showPassword3 ? "text" : "password"} handleChange={handleChange} handleShowPassword={handleShowPassword3} />
